...
const translations = {
    en: {
        ...
        'education.degree1.degree': 'Computer Science Degree',
        'education.degree1.school': 'University Name — City, Country',
        'education.degree1.period': '2024 - Present (Expected 2028)',
        'education.degree2.degree': 'High School Diploma',
        'education.degree2.school': 'School Name — City, Country',
        'education.degree2.school': 'Institution Name — Brasília, Brasil',
    ...
    pt: {
        ...
        'education.degree1.degree': 'Gestão da Tecnologia da Informação',
        'education.degree1.school': 'Faculdade Estácio — Brasília, Brasil',
        'education.degree1.period': 'Fev 2023 - Fev 2025 (Concluído)',
        'education.degree2.degree': 'Segunda Graduação',
        'education.degree2.school': 'Instituição — Brasília, Brasil',
        'education.degree2.period': 'Fev 2025 - Dez 2027 (Previsão)',
        'certifications.title': 'Certificações e Cursos',
        'certs.frontend': 'Formação Front-End',
        'certs.react': 'React: desenvolva aplicações web usando JSX e Hooks',
        'certs.fullstack': 'Full stack JavaScript: crie um projeto com React e Node.js',
        'certs.marketing': 'Formação Marketing Digital',
        'certs.socialmedia': 'Formação Social Media',
        'certs.canva': 'Formação Canva',
        'certs.python': 'Formação Praticando Python',
        'certs.entrepreneurship': 'Formação Empreendedorismo Digital',
        'certs.communication': 'Formação Comunicação',
        'certs.sales': 'Formação Técnicas de Venda',
        'certs.huggingface': 'Dominando Hugging Face com Python',
        'certs.ai.start': 'Começando em Inteligência Artificial',
        'certs.ai.fundamentals': 'Fundamentos do Mundo da Inteligência Artificial',
        'certs.ai.social': 'Mídias Sociais com Inteligência Artificial',
        'certs.ai.mysql': 'MySQL com Inteligência Artificial',
        'skills.title': 'Skills',
